      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
          ...
          <nav className="flex flex-wrap items-center gap-x-5 gap-y-2" aria-label="Footer navigation">
            ...
            <Link href="/search" className="text-sm text-zinc-600 hover:text-zinc-400 transition-colors">
              Search
            </Link>
            <Link href="/categories" className="text-sm text-zinc-600 hover:text-zinc-400 transition-colors">
              Categories
            </Link>
            <Link href="/cart" className="text-sm text-zinc-600 hover:text-zinc-400 transition-colors">
              Cart
            </Link>
          </nav>
          ...
          <div className="flex flex-col gap-3 sm:items-end">
            ...
            <p className="text-zinc-600 text-sm">
              © {year} Vercel, Inc. All rights reserved.
            </p>
          </div>
